...
def initialize_motor_pids():
    set_gain("waist", 1920, 200, 2000, 1000, 2400, 500, 50)
    set_gain("shoulder", 1920, 200, 3000, 400, 800, 500, 50)
    set_gain("elbow", 1920, 200, 1000, 500, 1200, 800, 0)
    set_gain("forearm_roll", 1920, 200, 1000, 500, 2000, 500, 0)
    set_gain("wrist_angle", 1920, 200, 100, 100, 2000, 0, 0)
    set_gain("wrist_rotate", 1000, 100, 100, 0, 1000, 0, 0)
